        ...
        <div className="flex items-center  justify-center min-h-screen bg-[url('images/themis.jpg')]">
            ...
            <div className="px-8 py-6 mt-4 w-9/12 min-w-max  text-left bg-white shadow-lg">
                ...
                <div className="flex items-center justify-end ml-6">
                            <Link to="/home"><button href="/home" className="px-6 py-2 mt-4 mx-4 text-white bg-gray-500 rounded-lg hover:bg-gray-400">Cancelar</button></Link>
                            <Link to="/home"><button href="/home" className="px-6 py-2 mt-4 text-white bg-blue-600 rounded-lg hover:bg-blue-900">Salvar</button></Link>
                        </div>
